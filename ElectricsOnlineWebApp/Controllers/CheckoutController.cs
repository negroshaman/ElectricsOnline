...
namespace ElectricsOnlineWebApp.Controllers
{
    public class CheckoutController : BaseController
    {
        ...
        public CheckoutController()
        {
            ...
            //List<State> states = _ctx.States.ToList<State>();
        ...
        public ActionResult Purchase()
        {
            ...
            ViewBag.States = _ctx.States.ToList<State>();
            ViewBag.Cards = cards;
        ...
        public ActionResult Purchase(ElectricsOnlineWebApp.Models.Customer customer)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    _ctx.Orders.Add(o);
                    int cStateId = int.Parse(c.State);
                    var salesTax = _ctx.StateTaxes.FirstOrDefault(s => s.StateId == cStateId);
